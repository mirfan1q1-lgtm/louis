...
export function StudentClassroom() {
  useSEO({
    title: 'Kelas Saya',
    description: 'Akses kelas, materi, dan tugas Anda di LOUIS - Platform pembelajaran interaktif.',
    keywords: 'kelas siswa, materi pembelajaran, tugas siswa, LOUIS siswa',
  });
  ...
  const loadClasses = async () => {
    try {
      ...
      for (const cs of classStudents || []) {
        ...
        if (teacherError || !teacherDataResult) {
              ...
              <SimpleGrid cols={2} spacing="sm">
                <Paper p="sm" withBorder radius="md">
                  <Group gap="xs" align="center">
                    ...
                    <div style={{ flex: 1 }}>
                      <Text size="lg" fw={700}>{classInfo.total_assignments}</Text>
                      <Text size="xs" c="dimmed">Total Tugas</Text>
                    </div>
                  </Group>
                </Paper>
                ...
                <Paper p="sm" withBorder radius="md">
                  <Group gap="xs" align="center">
                    ...
                    <div style={{ flex: 1 }}>
                      <Text size="lg" fw={700}>{classInfo.completed_assignments}</Text>
                ...
                <Paper p="sm" withBorder radius="md">
                  <Group gap="xs" align="center">
                    ...
                    <div style={{ flex: 1 }}>
                      <Text size="lg" fw={700}>{classInfo.upcoming_assignments}</Text>
                      <Text size="xs" c="dimmed">Mendatang</Text>
                    </div>
                  </Group>
                </Paper>
                ...
                <Paper p="sm" withBorder radius="md">
                  <Group gap="xs" align="center">
                    ...
                    <div style={{ flex: 1 }}>
                      <Text size="lg" fw={700}>{classInfo.recent_announcements}</Text>
                      <Text size="xs" c="dimmed">Pengumuman</Text>
                    </div>
                  </Group>
                </Paper>
                ...
                <Paper p="sm" withBorder radius="md">
                  <Group gap="xs" align="center">
                    ...
                    <div style={{ flex: 1 }}>
                      <Text size="lg" fw={700}>{materials.length}</Text>
                      <Text size="xs" c="dimmed">Materi</Text>
                    </div>
                  </Group>
                </Paper>
              </SimpleGrid>

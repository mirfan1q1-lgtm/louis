...
import { LoadingSpinner, DisqusComments } from '../../components';
...
export function StudentNewsroom() {
  useSEO({
    title: 'Newsroom',
    description: 'Baca berita dan pengumuman terbaru di LOUIS - Tetap update dengan informasi penting.',
    keywords: 'newsroom siswa, pengumuman sekolah, berita pendidikan, LOUIS newsroom',
  });

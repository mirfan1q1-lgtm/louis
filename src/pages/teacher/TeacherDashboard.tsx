...
export function TeacherDashboard() {
  useSEO({
    ...
    description: 'Dashboard guru LOUIS - Kelola kelas, siswa, tugas, dan aktivitas pembelajaran Anda.',
    keywords: 'dashboard guru, LOUIS guru, manajemen kelas, tugas guru',
  });
